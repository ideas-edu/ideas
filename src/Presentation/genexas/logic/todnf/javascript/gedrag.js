	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete") 
  		{
			...
			gegevens.expressie = myLanguage.lex(result);
			gegevens.werk = myLanguage.toUnicode(gegevens.expressie);
			gegevens.afleiding = myLanguage.toHtml(gegevens.expressie);
			gegevens.feedback = '<h4>DNF</h4><p>Het doel van de opdracht is een expresie in DNF.</p>'+
				'<h4>Werkveld</h4>'+
			...
			$('opgave').innerHTML = myLanguage.toHtml(gegevens.expressie);
    		...
    		historyStorage.put("vorigeAntwoord", result);
...
function submitAntwoord()
{
	...
	var oplossing = myLanguage.unLex($("werk").value);
	historyStorage.put("huidigeAntwoord", oplossing);
	var vorigeantwoord = historyStorage.get("vorigeAntwoord");
...
{ 
	...
	{ 
		...
		else 
		{
			...
			gegevens.expressie = myLanguage.lex(historyStorage.get("huidigeAntwoord"));
			
			historyStorage.put("vorigeAntwoord", historyStorage.get("huidigeAntwoord"));
		
			// vullen van het gegevens object voor de history
			gegevens.werk = $("werk").value;
