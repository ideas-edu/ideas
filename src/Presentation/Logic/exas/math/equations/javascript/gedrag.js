	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete") 
  	{
		...
		gegevens.feedback = '<h4>Oplossen</h4><p>Het doel van de opdracht is om de vergelijkingen op te lossen.</p>'+
			'<h4>Werkveld</h4>'+
			'<p>Wijzig de vergelijkingen in het werkveld.<br>(Schrijf er dus geen nieuwe vergelijkingen onder!)'+
