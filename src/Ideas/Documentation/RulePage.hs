...
--
-----------------------------------------------------------------------------
module Ideas.Documentation.RulePage (makeRulePages) where
...
import Ideas.Documentation.ExercisePage (idboxHTML)
import Ideas.Documentation.RulePresenter
import Ideas.Service.DomainReasoner
import Ideas.Service.RulesInfo (rewriteRuleToFMP, collectExamples, ExampleMap)
