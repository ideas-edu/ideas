...
<script type="text/javascript" src="/genexas/common/javascript/basis.js"></script>
<script type="text/javascript" src="javascript/gedrag.js"></script>
<script type="text/javascript" src="/genexas/common/javascript/help.js"></script>
<script type="text/javascript">addLoadEvent(initialiseer)</script>;
...
<input class="menu" type="button" id="regelsButton" value="<?php print Rules;?>" >
<input class="menu" type="button" id="genereerButton" value="<?php print NewExercise;?>" >
<br clear="all" >
...
<input class="helpbutton" id="sluitmenuregelsButton" type="button" value="<?php print Close;?>" >
<?php rules();?>
</div>

<div id="help" class="helpgebied onzichtbaar">
<input class="helpbutton"  id="sluitmenuhelpButton" type="button" value="<?php print Close1;?>" >
<?php help();?>
</div>

<div id="about" class="helpgebied onzichtbaar">
<input class="helpbutton"  id="sluitmenuaboutButton" type="button" value="<?php print Close2;?>" >
<?php about();?>
